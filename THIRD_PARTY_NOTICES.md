...
各包 README 和 Koishi 控制台 usage 均标明直接相关来源。原项目源码、图片、字体及可执行文件未随本包复制分发。Koishi 版本重写了命令、数据库和 OneBot 调用；行为逐项对应说明见源码中的 docs/MIGRATION-REVIEW.md。上游许可证文本保留在 licenses/，其权利不会被本项目 LICENSE 覆盖。
